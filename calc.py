...
def clear_input_feild(equation):
    global expression
...
def main():
    ...
    input_feild = Entry(window, textvariable=equation)
    input_feild.place(height=100)

    input_feild.grid(columnspan=4, ipadx=100, ipady=5)
    ...
    clear = Button(window, text='Clear', fg= 'white', bg='black', bd=0, command=lambda: clear_input_feild(equation),height=2, width=7)
